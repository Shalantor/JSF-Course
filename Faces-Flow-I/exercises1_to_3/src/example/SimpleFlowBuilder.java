...
public class SimpleFlowBuilder implements Serializable {
  ...
  public Flow defineFlow(@FlowBuilderParameter FlowBuilder flowBuilder) {
    String flowId = "JavaFlow";
    flowBuilder.id("", flowId);
    flowBuilder.viewNode(flowId, "/java-flow/flow-entry.xhtml")
               .markAsStartNode();
    flowBuilder.viewNode("page1", "/java-flow/one.xhtml");
    flowBuilder.viewNode("page2", "/java-flow/two.xhtml");
    flowBuilder.viewNode("page3", "/java-flow/three.xhtml");
    
    flowBuilder.returnNode("exit-flow")
               .fromOutcome("/java-flow-exit");
